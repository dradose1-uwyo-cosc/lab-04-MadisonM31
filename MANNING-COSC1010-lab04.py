...
# Lab 03
# Lab Section: 10
# Sources, people worked with, help given to: Special thanks to Michael Stoll, Austin Barner, and my COSC1010 lecture notes
...
for i in range(0, len(max_temps)):
    min_total = min_total + min_temps[i]
    if i == len(max_temps) -  1:
        min_total = min_total / 365
    max_total = max_total + max_temps[i]
    if i == len(max_temps) - 1:
        max_total = max_total / 365

print(f"The maximim average temperature in Laramie in 2023 was {max_total}")
print(f"The minimum average temperature in Laramie in 2023 was {min_total}")
...
print(f"The highest recorded temperature in Laramie in 2023 was {max_max}")
print(f"The lowest recorded temperature in Laramie in 2023 was {min_min}")